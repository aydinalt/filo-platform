...
export type NotificationItem={id:string;ruleId:string|null;sourceType:CreateNotificationRuleInput["sourceType"]|"provider_incident";sourceId:string;title:string;message:string;severity:"info"|"warning"|"critical";vehicleId:string|null;vehiclePlate:string|null;recipientUserId:string;actionTarget:NotificationActionTarget|null;readAt:string|null;archivedAt:string|null;createdAt:string};
...
export type NotificationArchiveReconciliation={id:string;reconciliationKey:string;source:"manual"|"scheduler";staleAfterMinutes:number;reconciledCount:number;initiatedBy:string;createdAt:string};
export type NotificationRetentionSettings={readRetentionDays:number;automaticArchiveEnabled:boolean;archiveIntervalHours:number;archiveBatchSize:number;lastArchiveAt:string|null;lastArchiveKey:string|null;lastArchiveSummary:{archivedCount:number;eligibleRemaining:number;source:"manual"|"scheduler"}|null;nextDueAt:string|null;automaticReconciliationEnabled:boolean;reconciliationIntervalMinutes:number;reconciliationStaleAfterMinutes:number;lastReconciliationAt:string|null;lastReconciliationKey:string|null;lastReconciliationSummary:{reconciledCount:number;source:"manual"|"scheduler"}|null;nextReconciliationDueAt:string|null;updatedAt:string|null};
