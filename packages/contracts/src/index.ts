...
export type NotificationArchiveReconciliationReminderRun={id:string;runKey:string;source:"manual"|"scheduler";scannedCount:number;notificationsCreated:number;initiatedBy:string;initiatedByName:string|null;createdAt:string};
