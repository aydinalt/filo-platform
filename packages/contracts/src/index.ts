...
export type NotificationArchiveReconciliation={id:string;reconciliationKey:string;source:"manual"|"scheduler";staleAfterMinutes:number;reconciledCount:number;notificationsCreated:number;initiatedBy:string;createdAt:string};
