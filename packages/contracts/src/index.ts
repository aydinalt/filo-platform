...
export type NotificationRetention={settings:NotificationRetentionSettings;eligibleCount:number;reconciliationSummary:NotificationArchiveReconciliationSummary;recentRuns:NotificationArchiveRun[];recentAttempts:NotificationArchiveAttempt[];recentReconciliations:NotificationArchiveReconciliation[];recentReminderRuns:NotificationArchiveReconciliationReminderRun[];recentReminderMaintenanceRuns:NotificationArchiveReconciliationReminderMaintenanceRun[]};
