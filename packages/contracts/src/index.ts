...
export type NotificationRetention={settings:NotificationRetentionSettings;eligibleCount:number;recentRuns:NotificationArchiveRun[];recentAttempts:NotificationArchiveAttempt[];recentReconciliations:NotificationArchiveReconciliation[]};
