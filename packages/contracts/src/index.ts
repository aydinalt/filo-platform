...
export type NotificationArchiveAttempt={id:string;runKey:string;source:"manual"|"scheduler"|"retry";status:"running"|"succeeded"|"skipped"|"failed";outcomeCode:string|null;retryOfAttemptId:string|null;retryNumber:number;initiatedBy:string;archivedCount:number|null;eligibleRemaining:number|null;startedAt:string;completedAt:string|null;createdAt:string};
