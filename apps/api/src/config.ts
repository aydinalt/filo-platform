...
export function loadConfig(environment: RuntimeEnvironment = process.env) {
  ...
  return Object.freeze({
    ...
    authLoginRateLimitMax: boundedInteger(
      ...
      environment.AUTH_LOGIN_RATE_LIMIT_MAX,
      5,
      1,
      20,
    ),
    authLoginRateLimitWindowMs: boundedInteger(
      "AUTH_LOGIN_RATE_LIMIT_WINDOW_MS",
      environment.AUTH_LOGIN_RATE_LIMIT_WINDOW_MS,
      60_000,
      10_000,
      900_000,
    ),
    ...
    sessionRecordRetentionDays: boundedInteger(
      "SESSION_RECORD_RETENTION_DAYS",
      environment.SESSION_RECORD_RETENTION_DAYS,
      30,
      7,
      365,
    ),
    sessionCleanupBatchSize: boundedInteger(
      "SESSION_CLEANUP_BATCH_SIZE",
      environment.SESSION_CLEANUP_BATCH_SIZE,
      200,
      10,
      1_000,
    ),
