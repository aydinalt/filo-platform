...
function ProviderIncidentsPanel({ incidents, scanStatus, onSync, onUpdate }: { incidents: NotificationProviderIncident[]; scanStatus: NotificationProviderIncidentScanStatus | null; onSync: () => Promise<void>; onUpdate: (id: string, status: "acknowledged" | "resolved", notes: string | null) => Promise<void> }) {
